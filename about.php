		...
		<div class="about">
			<div>
				<section>
					...
					<div>
						<p><strong>Prerequisites:</strong> COMP 1850 or equivalent HTML5 and CSS3 knowledge.</p>
						<p><strong>Start Dates:</strong> September 10, September 12, and October 28 (6 week accellerated course.)</p>
						<p><strong>Total Class Hours:</strong> 36</p>
					</div>
				</section>
			</div>
			<div>
				...
				<section>
					...
					<div>
						<ul>
							...
							<li>By the end of this course successful students will be able to build dynamic and semantically marked-up content that is viewable on mobile and desktop screen sizes.</li>
						</ul>
					</div>
				</section>
			</div>
			<div>
				<section>
					<div>
						<h1>Course Learning Outcomes / Competencies</h1>
					</div>
					<div>
						<p>Upon successful completion of this course, the student will be able to:</p>
						<ul>
							<li>Gain a deeper understanding of HTML, CSS and advanced topics in web development.</li>
							<li>Focus on best practices in web page and web site design.</li>
			...
			<div>
				<section class="center-on-narrow">
					<div>
						<h1>Evaluation Criteria</h1>
					</div>
					<div>
						<p><strong>Assignments 1 - 7:</strong> 20%</p>
						<p><strong>Mid-Term Project:</strong> 20%</p>
						<p><strong>Mid-Term Exam:</strong> 10%</p>
						<p><strong>Final Project:</strong> 30%</p>
						<p><strong>Final Exam:</strong> 20%</p>
					</div>
				</section>
			</div>
		</div>
