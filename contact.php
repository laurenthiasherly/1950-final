	...
	<main class="contact"> 
		...
		<div class="row contact-info">
			<div class="left-contact half text-center">
				...
				<p> 3700 Willingdon Avenue, <br>Burnaby V5G 3H2 BC, Canada </p><br><br><br>
			</div>
			<div class="right-contact half">
				<form>
					...
					<input type="radio" name="whichstudent" id="whichstudent" checked value="prospective"> Prospective student<br>
